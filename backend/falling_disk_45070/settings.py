"""
Django settings for falling_disk_45070 project.
...
ROOT_URLCONF = 'falling_disk_45070.urls'
...
WSGI_APPLICATION = 'falling_disk_45070.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_disk_45070 API",
    "DESCRIPTION": "API documentation for falling_disk_45070 App",
    "VERSION": "v1",
}
